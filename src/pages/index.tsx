        ...
        {isMobile ? (
          ...
          <div className="relative w-full h-[80vh] max-w-[90%] mx-auto flex justify-center">
            ...
            <div className="relative w-[95%] h-full">
              {/* 动画区域 - 居左，缩小至90% */}
              <div className="absolute top-[2%] left-[30%] transform -translate-x-1/2 w-auto h-[88%] flex flex-col items-center scale-90 origin-top">
                {/* 将标题放在动画框上方中央 */}
                ...
                <div className="tech-card rounded-xl bg-gray-800 p-3 h-full w-full">
                  <div className="border-2 border-opacity-40 border-tech-blue rounded-lg flex items-center justify-center h-full overflow-hidden glowing-border">
                    <CharacterAnimation
                      character={character}
                      isAnimating={isAnimating}
                      response={aiResponse}
              ...
              {/* 对话区域 - 右侧，底部对齐，距离减小 */}
              <div className="absolute bottom-[14%] right-[12%] w-[32%] tech-card rounded-xl bg-gray-800 p-3">
